...
Como altos valores p dan evidencia a favor de H_0 y bajos valores dan evidencia en contra, sería posible idear un contraste de hipótesis que consista en rechazar H_0 si pval(t) < α. Si la distribución de T es continua entonces el valor de α sería un tamaño de contraste exacto. En la práctica así es cómo se utiliza el valor p, comparándolo contra el nivel de significancia (tamaño del contraste) y decidiendo si se rechaza o no la hipótesis nula.
